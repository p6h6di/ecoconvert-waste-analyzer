    ...
    >
      <div className="flex items-center justify-between px-6 md:px-12 max-w-7xl mx-auto h-16">
        ...
        >
          ...
          />
          <h1 className="font-bold text-lg">EcoConvert</h1>
        </motion.div>
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          >
            <Link
              href="/sign-in"
              className="px-6 py-2.5 rounded-xl bg-[#F2F5F0] font-medium text-sm transition-all hover:bg-[#E8EDE5] active:scale-95"
            >
              Log in
            </Link>
            <Link
